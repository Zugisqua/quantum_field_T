...
<\body>
  ...
  <\description>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|<around|\<langle\>|0|\|>T\<phi\><around*|(|x|)>\<phi\><around*|(|y|)><around|\||0|\<rangle\>>>|<cell|=>|<cell|<big|int><frac|\<mathd\><rsup|4>p|<around*|(|2\<pi\>|)><rsup|4>><frac|i|p<rsup|2>-m<rsup|2>>e<rsup|-i
      p<around*|(|x-y|)>>>>>>
    </eqnarray*>
    ...
    <\description>
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|<around|\<langle\>|0|\|>T\<phi\><around*|(|x|)>\<phi\><around*|(|y|)><around|\||0|\<rangle\>>>|<cell|=>|<cell|<big|int><frac|\<mathd\><rsup|4>p|<around*|(|2\<pi\>|)><rsup|4>><frac|i|p<rsup|2>-m<rsup|2>>e<rsup|-i
        p<around*|(|x-y|)>>>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|\<mathd\><rsup|3>p|<around*|(|2\<pi\>|)><rsup|3>>e<rsup|i
        <wide|p|\<vect\>>\<cdot\><around*|(|<wide|x|\<vect\>>-<wide|y|\<vect\>>|)>><big|int><frac|\<mathd\>p<rsub|0>|2\<pi\>><frac|i|p<rsup|2>-m<rsup|2>>e<rsup|-i
        p<rsub|0><around*|(|x<rsub|0>-y<rsub|0>|)>>>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|\<mathd\><rsup|3>p|<around*|(|2\<pi\>|)><rsup|3>>e<rsup|i
        <wide|p|\<vect\>>\<cdot\><around*|(|<wide|x|\<vect\>>-<wide|y|\<vect\>>|)>><big|int><frac|\<mathd\>p<rsub|0>|2\<pi\>><frac|i|p<rsub|0><rsup|2>-<around*|\||<wide|p|\<vect\>>|\|><rsup|2>-m<rsup|2>>e<rsup|-i
        p<rsub|0><around*|(|x<rsub|0>-y<rsub|0>|)>>>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|\<mathd\><rsup|3>p|<around*|(|2\<pi\>|)><rsup|3>>e<rsup|i
        <wide|p|\<vect\>>\<cdot\><around*|(|<wide|x|\<vect\>>-<wide|y|\<vect\>>|)>><big|int><frac|\<mathd\>p<rsub|0>|2\<pi\>><frac|i|p<rsub|0><rsup|2>-w<rsup|2><rsub|<wide|p|\<vect\>>>>e<rsup|-i
        p<rsub|0><around*|(|x<rsub|0>-y<rsub|0>|)>>>>>>
      </eqnarray*>

      <\eqnarray*>
        <tformat|<cwith|3|3|3|3|cell-halign|l>|<table|<row|<cell|inte>|<cell|=>|<cell|<frac|1|2\<pi\>><big|int><rsub|-\<infty\>><rsup|+\<infty\>>\<mathd\>p<rsub|0><frac|i|p<rsub|0><rsup|2>-w<rsup|2><rsub|<wide|p|\<vect\>>>>e<rsup|-i
        p<rsub|0><around*|(|x<rsub|0>-y<rsub|0>|)>>>>|<row|<cell|>|<cell|=>|<cell|<frac|1|2\<pi\>><around*|[|<big|oint><rsub|C>-<big|int><rsub|C<rsub|R>>-<big|int><rsub|C<rsub|\<varepsilon\><rsub|1>>>-<big|int><rsub|C<rsub|\<varepsilon\><rsub|2>>>|]>\<mathd\>p<rsub|0><frac|i|p<rsub|0><rsup|2>-w<rsup|2><rsub|<wide|p|\<vect\>>>>e<rsup|-i
        p<rsub|0><around*|(|x<rsub|0>-y<rsub|0>|)>>>>|<row|<cell|>|<cell|=>|<cell|<frac|1|2\<pi\>><around*|(|0-0-<around*|(|-\<pi\>i
        k<rsub|1>|)>-<around*|(|-\<pi\>i k<rsub|2>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|\<pi\>i|2\<pi\>>\<times\><frac|i|2w<rsub|<wide|p|\<vect\>>>><around*|(|e<rsup|-i
      ...
      <\description>
        ...
        <\eqnarray*>
          <tformat|<table|<row|<cell|K=lim<rsub|z\<rightarrow\>\<infty\>>z
          <frac|1|z<rsup|2>-w<rsub|<wide|p|\<vect\>>><rsup|2>>e<rsup|-i
          z<around*|(|x<rsub|0>-y<rsub|0>|)>>>|<cell|=>|<cell|lim<rsub|z\<rightarrow\>\<infty\>><frac|1|z>e<rsup|-i
          z<around*|(|x<rsub|0>-y<rsub|0>|)>>>>|<row|<cell|>|<cell|=>|<cell|0>>>>
        </eqnarray*>

        <item*|><math|2<rsup|o>>

        <\eqnarray*>
          <tformat|<table|<row|<cell|k<rsub|1>=lim<rsub|z\<rightarrow\>-w<rsub|<wide|p|\<vect\>>>><frac|i<around*|(|z+w<rsub|<wide|p|\<vect\>>>|)>|z<rsup|2>-w<rsup|2><rsub|<wide|p|\<vect\>>>>e<rsup|-i
          z<around*|(|x<rsub|0>-y<rsub|0>|)>>>|<cell|=>|<cell|lim<rsub|z\<rightarrow\>-w<rsub|<wide|p|\<vect\>>>><frac|i|z-w<rsub|<wide|p|\<vect\>>>>e<rsup|-i
          z<around*|(|x<rsub|0>-y<rsub|0>|)>>>>|<row|<cell|>|<cell|=>|<cell|-<frac|i|2w<rsub|<wide|p|\<vect\>>>>e<rsup|i
          w<rsub|<wide|p|\<vect\>>><around*|(|x<rsub|0>-y<rsub|0>|)>>>>>>
        </eqnarray*>
        ...
        <\eqnarray*>
          <tformat|<table|<row|<cell|k<rsub|2>=lim<rsub|z\<rightarrow\>w<rsub|<wide|p|\<vect\>>>><frac|i<around*|(|z-w<rsub|<wide|p|\<vect\>>>|)>|z<rsup|2>-w<rsub|<wide|p|\<vect\>>><rsup|2>>e<rsup|-i
          z<around*|(|x<rsub|0>-y<rsub|0>|)>>>|<cell|=>|<cell|lim<rsub|z\<rightarrow\>w<rsub|<wide|p|\<vect\>>>><frac|i|z+w<rsub|<wide|p|\<vect\>>>>e<rsup|-i
          z<around*|(|x<rsub|0>-y<rsub|0>|)>>>>|<row|<cell|>|<cell|=>|<cell|<frac|i|2w<rsub|<wide|p|\<vect\>>>>e<rsup|-i
          w<rsub|<wide|p|\<vect\>>><around*|(|x<rsub|0>-y<rsub|0>|)>>>>>>
        </eqnarray*>
      ...
      can't see where is the <math|-<frac|1|2>>

      <item*|ii>Green's funtion verify

      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|(|\<box\>
        +m<rsup|2>|)><around|\<langle\>|0|\|><around*|[|\<phi\><around*|(|x|)>,\<phi\><around*|(|y|)>|]><around|\||0|\<rangle\>>>|<cell|=>|<cell|<around*|(|\<box\>
        +m<rsup|2>|)><big|int><frac|\<mathd\><rsup|4>p|i<around*|(|2\<pi\>|)><rsup|4>><frac|1|m<rsup|2>-p<rsup|2>>e<rsup|-i
        p<around*|(|x-y|)>>>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|\<mathd\><rsup|4>p|i<around*|(|2\<pi\>|)><rsup|4>><around*|{|<around*|(|\<box\>
        +m<rsup|2>|)><frac|1|m<rsup|2>-p<rsup|2>>e<rsup|-i
        p<around*|(|x-y|)>>|}>>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|\<mathd\><rsup|4>p|i<around*|(|2\<pi\>|)><rsup|4>><around*|{|<around*|(|-p<rsup|2>
        +m<rsup|2>|)><frac|1|m<rsup|2>-p<rsup|2>>e<rsup|-i
        p<around*|(|x-y|)>>|}>>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|\<mathd\><rsup|4>p|i<around*|(|2\<pi\>|)><rsup|4>><around*|{|e<rsup|-i
        p<around*|(|x-y|)>>|}>>>|<row|<cell|>|<cell|=>|<cell|-i\<delta\><around*|(|x-y|)>>>>>
      </eqnarray*>
